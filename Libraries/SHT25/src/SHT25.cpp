 ...
 **********************************************************/
float SHT25Class::GetHumidity(void)
{
 ...
 **********************************************************/
float SHT25Class::GetTemperature(void)
{
 ...
 **********************************************************/
float SHT25Class::GetDewPoint(void)
{
...
uint16_t SHT25Class::readSensor(uint8_t command)
{
    uint16_t result;

    Wire.beginTransmission(eSHT25Address);
    Wire.write(command);
    Wire.endTransmission();

    delay(100);
    Wire.requestFrom(eSHT25Address, 3);
